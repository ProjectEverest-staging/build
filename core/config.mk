...
ifneq ($(EVEREST_BUILD),)
include vendor/everest/config/BoardConfigEverest.mk
endif
...
ifneq ($(EVEREST_BUILD),)
ifneq ($(wildcard device/everest/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/everest/sepolicy/common/sepolicy.mk)
endif
endif
